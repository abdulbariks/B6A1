...
## TypeScript-এ enum কী এবং কেন ব্যবহার করা হয়?

TypeScript আমাদের কোডকে আরও গুছানো, readable এবং type-safe করার জন্য অনেক শক্তিশালী ফিচার দেয়। এর মধ্যে একটি খুবই গুরুত্বপূর্ণ ফিচার হলো enum।
enum ব্যবহার করে আমরা কিছু নির্দিষ্ট, পূর্বনির্ধারিত মানকে একটি নামের অধীনে গ্রুপ করতে পারি।সহজভাবে বললে, enum আমাদের বলে দেয়— “এই ভেরিয়েবলটি কেবল এই নির্দিষ্ট কয়েকটি মানের মধ্যেই সীমাবদ্ধ থাকবে।”

### enum কেন ব্যবহার করা হয়?

ধরা যাক, আপনার অ্যাপে ব্যবহারকারীর role আছে—admin, user, moderator।
আপনি চাইলে string লিখে লিখে ব্যবহার করতে পারেন, কিন্তু এতে সমস্যা হতে পারে:

```ts
let role = "admn"; // ❌ typo, কিন্তু error নেই
```

এই ধরনের ভুল এড়ানোর জন্যই enum ব্যবহার করা হয়।

### enum ব্যবহারের সুবিধা

- টাইপ সেফটি নিশ্চিত করে
- typo বা ভুল value ব্যবহারের ঝুঁকি কমায়
- কোড আরও readable ও maintainable হয়
- বড় প্রোজেক্টে consistency বজায় রাখে

### Numeric Enum — সংখ্যা ভিত্তিক enum

Numeric enum হলো TypeScript-এর ডিফল্ট enum।
এতে প্রতিটি enum member একটি সংখ্যার সাথে যুক্ত থাকে।
...
এখানে TypeScript নিজে থেকেই সংখ্যা assign করেছে: Up = 0,Down = 1,Left = 2,Right = 3

চাইলে নিজে থেকে মান সেট করতে পারেন:
...
Numeric enum-এর একটি বিশেষ সুবিধা হলো reverse mapping—
মানে, সংখ্যা থেকে নামও বের করা যায়।

```ts
console.log(StatusCode[200]); // "Success"
```

### String Enum — string ভিত্তিক enum

String enum-এ প্রতিটি member একটি নির্দিষ্ট string মান ধারণ করে।
এগুলো বেশি readable এবং debugging-এ সুবিধাজনক।
...
এখানে প্রতিটি মান স্পষ্টভাবে দেখা যাচ্ছে, ফলে log বা API response-এ বোঝা সহজ হয়।

### String enum-এর সুবিধা

- Output আরও পরিষ্কার ও অর্থবহ
- API, database, বা UI state management-এ খুব কার্যকর
- Numeric enum-এর মতো অপ্রত্যাশিত সংখ্যা আসে না

### কখন কোনটা ব্যবহার করবেন?

- Numeric enum ব্যবহার করুন যখন সংখ্যা গুরুত্বপূর্ণ (যেমন HTTP status, steps)
- String enum ব্যবহার করুন যখন readability ও clarity বেশি দরকার
- বড় অ্যাপ্লিকেশনে magic string এড়াতে সবসময় enum prefer করুন

TypeScript-এর enum আমাদের কোডকে আরও নিরাপদ, পরিষ্কার এবং পেশাদার করে তোলে।
Numeric enum দ্রুত এবং flexible, আর String enum বেশি readable ও predictable।
সঠিক জায়গায় সঠিক enum ব্যবহার করলে আপনার কোড হবে কম bug-যুক্ত এবং সহজে maintain করা যাবে।

5. Provide an example of using **union** and **intersection** types in TypeScript.

## TypeScript-এ Union এবং Intersection Types

TypeScript-এর সবচেয়ে শক্তিশালী বৈশিষ্ট্যগুলোর একটি হলো এর টাইপ সিস্টেম। জটিল ডেটা, ভিন্ন ভিন্ন কাঠামো, কিংবা একাধিক টাইপ ব্যবহারের ক্ষেত্রে Union এবং Intersection টাইপ খুবই সাহায্য করে। একদম নতুন ডেভেলপার থেকে শুরু করে অভিজ্ঞ সবাই এই দুটি টাইপ ব্যবহার করেন, কারণ এগুলো কোডকে নমনীয় ও টাইপ-সেফ করে।

### Union Type

Union টাইপ ব্যবহার করলে একটি ভেরিয়েবল বা প্যারামিটার একাধিক ধরনের মান গ্রহণ করতে পারে।
এটা লেখা হয় | (pipe) চিহ্ন দিয়ে।
...
এখানে value কখনও string, আবার কখনও number হতে পারে।
এটি তখনই কাজে লাগে যখন আপনি জানেন একটি ভ্যালু দুই বা তার বেশি টাইপের হতে পারে।
...
এখানে id হতে পারে number বা string।
কিন্তু union টাইপের ক্ষেত্রে TypeScript সরাসরি string বা number-এর মেথড ব্যবহার করতে দেয় না, কারণ সে নিশ্চিত নয় কোন টাইপটি আসছে।

### Intersection Type

Intersection টাইপ হলো বিপরীত দিকের—এটি একই ভেরিয়েবলে একাধিক টাইপের properties একত্রে থাকতে বাধ্য করে।
এটি লেখা হয় & (ampersand) চিহ্ন দিয়ে।
...
এখানে Staff টাইপ হলো Person + Employee এর সংমিশ্রণ।
অর্থাৎ একটি Staff অবজেক্টে অবশ্যই name এবং employeeId দুটোই থাকতে হবে।

### কেন এগুলো গুরুত্বপূর্ণ?

- API থেকে ভিন্ন ভিন্ন ডেটা এলে Union কাজে লাগে
- জটিল অবজেক্ট তৈরি করতে Intersection অপরিহার্য
- কোড আরও readable, safe এবং predictable হয়
- বড় প্রোজেক্টে টাইপ সিস্টেম শক্তিশালী হয়

TypeScript-এ Union এবং Intersection টাইপ হলো টাইপ ম্যানেজমেন্টের দুইটি অত্যন্ত শক্তিশালী অস্ত্র।
Union আমাদের flexible ইনপুট দেয়, আর Intersection নিশ্চিত করে অবজেক্টটি সম্পূর্ণ এবং নির্ভরযোগ্য।
এই দুই ফিচার ভালোভাবে শিখলে আপনার TypeScript দক্ষতা আরও শক্তিশালী হবে এবং কোড হবে নিরাপদ ও maintainable।
